...
async function getSongs(folder) {
    ...
    async function main() {
        ...
        document.querySelector(".seekbar").addEventListener("click", e => {
            ...
            //     currentSong.currentTime = (currentSong.duration * percent) / 100; chat gpt code

            currentSong.currentTime = ((currentSong.duration) * percent) / 100 //apna code

        })
        // Add event listener for Hamburger
        // console.log("kya diikkat h bhai")
